package app.jigrajs.plugins.keyboard;
...
public class Keyboard {
  ...
  public void setKeyboardEventListener(
    @Nullable KeyboardEventListener keyboardEventListener
  ) {
    ...
    ViewCompat.setWindowInsetsAnimationCallback(
      ...
      new WindowInsetsAnimationCompat.Callback(
        ...
        public WindowInsetsAnimationCompat.BoundsCompat onStart(
          ...
          boolean showingKeyboard = ViewCompat
            .getRootWindowInsets(rootView)
            .isVisible(WindowInsetsCompat.Type.ime());
          WindowInsetsCompat insets = ViewCompat.getRootWindowInsets(rootView);
          int imeHeight = insets.getInsets(WindowInsetsCompat.Type.ime())
            .bottom;
