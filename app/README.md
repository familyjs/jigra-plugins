...
For being able to open the app from a custom scheme you need to register the scheme first. You can do it by editing the [`Info.plist`](https://jigrajs.web.app/docs/ios/configuration#configuring-infoplist) file and adding this lines.
...
<array>
  <dict>
    ...
    <string>com.getjigra.jigra</string>
...
`custom_url_scheme` value is stored in `strings.xml`. When the Android platform is added, `@jigra/cli` adds the app's package name as default value, but can be replaced by editing the `strings.xml` file.
...
On Android it's fired when the Jigra's Activity [onResume](https://developer.android.com/reference/android/app/Activity#onResume()) and [onStop](https://developer.android.com/reference/android/app/Activity#onStop()) methods gets called.
...
On Android it's fired when the Jigra's Activity [onPause](https://developer.android.com/reference/android/app/Activity#onPause()) method gets called.
...
On Android it's fired when the Jigra's Activity [onResume](https://developer.android.com/reference/android/app/Activity#onResume()) method gets called,
...
To avoid this, Jigra stores all restored activity results on launch.
