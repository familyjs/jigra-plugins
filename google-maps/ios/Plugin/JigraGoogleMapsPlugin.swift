...
extension GMSMapViewType {
    static func fromString(mapType: String) -> GMSMapViewType {
        ...
        case "None":
            return .none
        default:
            print("JigraGoogleMaps Warning: unknown mapView type '\(mapType)'.  Defaulting to normal.")
            return .normal
        }
    }
...
@objc(JigraGoogleMapsPlugin)
public class JigraGoogleMapsPlugin: JIGPlugin, GMSMapViewDelegate {
    ...
    @objc func create(_ call: JIGPluginCall) {
        do {
            if !isInitialized {
    ...
    @objc func destroy(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func addMarkers(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func removeMarkers(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func removeMarker(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func addPolygons(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func addPolylines(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func removePolygons(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func addCircles(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func removeCircles(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func removePolylines(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func setCamera(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func getMapType(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func setMapType(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func enableIndoorMaps(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func enableTrafficLayer(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func enableAccessibilityElements(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func setPadding(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func enableCurrentLocation(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func enableClustering(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func disableClustering(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func onScroll(_ call: JIGPluginCall) {
    ...
    @objc func getMapBounds(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func mapBoundsContains(_ call: JIGPluginCall) {
        do {
    ...
    @objc func fitBounds(_ call: JIGPluginCall) {
        do {
            guard let id = call.getString("id") else {
                throw GoogleMapErrors.invalidMapId
            }
    ...
    @objc func mapBoundsExtend(_ call: JIGPluginCall) {
        do {
            guard let boundsObject = call.getObject("bounds") else {
                throw GoogleMapErrors.invalidArguments("Invalid bounds provided")
            }
    ...
    private func handleError(_ call: JIGPluginCall, error: Error) {
