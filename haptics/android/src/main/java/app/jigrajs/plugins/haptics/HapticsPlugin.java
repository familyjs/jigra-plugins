package app.jigrajs.plugins.haptics;

import app.jigrajs.plugins.haptics.arguments.HapticsImpactType;
import app.jigrajs.plugins.haptics.arguments.HapticsNotificationType;
...
public class HapticsPlugin extends Plugin {
  ...
  public void impact(PluginCall call) {
    implementation.performHaptics(
      HapticsImpactType.fromString(call.getString("style"))
    );
    call.resolve();
  }
  ...
  public void notification(PluginCall call) {
    implementation.performHaptics(
      HapticsNotificationType.fromString(call.getString("type"))
    );
    call.resolve();
  }
