package app.jigrajs.plugins.network;
...
public class NetworkPlugin extends Plugin {
  ...
  protected void handleOnResume() {
    ...
    if (
      ...
      (
        prePauseNetworkStatus.connected ||
        afterPauseNetworkStatus.connectionType !=
        prePauseNetworkStatus.connectionType
      )
    ) {
      Log.d(
        "Jigra/NetworkPlugin",
  ...
  private void updateNetworkStatus() {
    notifyListeners(
      ...
      parseNetworkStatus(implementation.getNetworkStatus())
    );
  }
