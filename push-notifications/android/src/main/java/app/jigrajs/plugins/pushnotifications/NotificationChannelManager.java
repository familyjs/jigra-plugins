package app.jigrajs.plugins.pushnotifications;
...
public class NotificationChannelManager {
  ...
  public static final String FOREGROUND_NOTIFICATION_CHANNEL_ID =
    "PushDefaultForeground";
  ...
  public void createChannel(PluginCall call) {
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
      ...
      channel.put(
        CHANNEL_USE_LIGHTS,
        call.getBoolean(CHANNEL_USE_LIGHTS, false)
      );
      channel.put(
        CHANNEL_LIGHT_COLOR,
        call.getString(CHANNEL_LIGHT_COLOR, null)
      );
  ...
  public void createChannel(JSObject channel) {
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
      ...
      notificationChannel.setLockscreenVisibility(
        channel.getInteger(CHANNEL_VISIBILITY)
      );
    ...
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
      ...
      for (NotificationChannel notificationChannel : notificationChannels) {
        ...
        channel.put(
          ...
          String.format(
            "#%06X",
            (0xFFFFFF & notificationChannel.getLightColor())
          )
        );
        Logger.debug(
          Logger.tags("NotificationChannel"),
          "visibility " + notificationChannel.getLockscreenVisibility()
        );
        Logger.debug(
          Logger.tags("NotificationChannel"),
