...
Jigra 4 uses the **[Android 12 Splash Screen API](https://developer.android.com/guide/topics/ui/splash-screen)** and the `androidx.core:core-splashscreen` compatibility library to make it work on Android 11 and below.
...
If, instead, you want to show the splash screen for a fixed amount of time, set `launchShowDuration` in your [Jigra configuration file](https://jigrajs.web.app/docs/config).
...
If you want to show a spinner on top of the splash screen, set `showSpinner` to `true` in your [Jigra configuration file](https://jigrajs.web.app/docs/config).
...
```ts
/// <reference types="@jigra/splash-screen" />
