package app.jigrajs.plugins.preferences;
...
public class PreferencesPlugin extends Plugin {
  ...
  public void load() {
    preferences =
      new Preferences(getContext(), PreferencesConfiguration.DEFAULTS);
  }
  ...
  public void configure(PluginCall call) {
    try {
      ...
      configuration.group =
        call.getString("group", PreferencesConfiguration.DEFAULTS.group);
  ...
  public void migrate(PluginCall call) {
    ...
    Preferences oldPreferences = new Preferences(
      getContext(),
      PreferencesConfiguration.DEFAULTS
    );
