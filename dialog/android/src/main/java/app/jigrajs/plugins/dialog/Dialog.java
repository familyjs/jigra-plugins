package app.jigrajs.plugins.dialog;
...
public class Dialog {
  ...
  public static void alert(
    ...
    final String alertOkButtonTitle = okButtonTitle == null
      ? "OK"
      : okButtonTitle;
  ...
  public static void confirm(
    ...
    final String confirmOkButtonTitle = okButtonTitle == null
      ? "OK"
      : okButtonTitle;
    final String confirmCancelButtonTitle = cancelButtonTitle == null
      ? "Cancel"
      : cancelButtonTitle;
  ...
  public static void prompt(
    ...
    final String promptOkButtonTitle = okButtonTitle == null
      ? "OK"
      : okButtonTitle;
    final String promptCancelButtonTitle = cancelButtonTitle == null
      ? "Cancel"
      : cancelButtonTitle;
    final String promptInputPlaceholder = inputPlaceholder == null
      ? ""
      : inputPlaceholder;
