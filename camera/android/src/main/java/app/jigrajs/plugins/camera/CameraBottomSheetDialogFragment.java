...
public class CameraBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  void setOptions(
    List<String> options,
    BottomSheetOnSelectedListener selectedListener,
    BottomSheetOnCanceledListener canceledListener
  ) {
  ...
  public void setupDialog(Dialog dialog, int style) {
    ...
    CoordinatorLayout.LayoutParams params = (CoordinatorLayout.LayoutParams) (
      (View) parentLayout.getParent()
    ).getLayoutParams();
    CoordinatorLayout.Behavior behavior = params.getBehavior();

    if (behavior != null && behavior instanceof BottomSheetBehavior) {
      ((BottomSheetBehavior) behavior).addBottomSheetCallback(
