...
public class ImageUtils {
  ...
  public static Bitmap resize(
    Bitmap bitmap,
    final int desiredMaxWidth,
    final int desiredMaxHeight
  ) {
    return ImageUtils.resizePreservingAspectRatio(
      bitmap,
      desiredMaxWidth,
      desiredMaxHeight
    );
   ...
   * @return a new, scaled Bitmap
   */
  private static Bitmap resizePreservingAspectRatio(
    Bitmap bitmap,
    final int desiredMaxWidth,
    final int desiredMaxHeight
  ) {
  ...
  private static int getOrientation(final Context c, final Uri imageUri)
    throws IOException {
    int result = 0;
  ...
  public static ExifWrapper getExifData(
    final Context c,
    final Bitmap bitmap,
    final Uri imageUri
  ) {
